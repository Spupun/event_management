...
<body>
    <div class="container my-5">
        <button class="btn btn-primary"><a href="upcoming_event.php">Add Events</a></button>
        <button class="btn btn-success"><a href="view_past_event.php">View Past Events</a></button>
